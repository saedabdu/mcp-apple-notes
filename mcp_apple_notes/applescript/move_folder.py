...
class MoveFolderOperations(BaseAppleScriptOperations):
    ...
    @staticmethod
    async def move_folder_by_id(folder_id: str, folder_name: str, target_path: str = "") -> Dict[str, Any]:
        ...
        return MoveFolderOperations._parse_move_by_id_result(result, folder_id, folder_name, target_path)
    
    @staticmethod
    def _parse_move_by_id_result(result: str, folder_id: str, folder_name: str, target_path: str) -> Dict[str, str]:
