...
class DeleteNoteOperations(BaseAppleScriptOperations):
    ...
    @staticmethod
    async def delete_note_by_id_and_name(note_id: str, note_name: str) -> Dict[str, str]:
        ...
        return DeleteNoteOperations._parse_delete_by_id_and_name_result(result, note_id, note_name)
    
    @staticmethod
    def _parse_delete_by_id_and_name_result(result: str, note_id: str, note_name: str) -> Dict[str, str]:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to parse delete by ID and name result: {str(e)}")
